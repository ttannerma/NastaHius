...
//Tämä funktio validoi sille parametrina annettu sähköposti.
...
window.addEventListener('load', () => {
    ...
    */
    ...
    //Tämä on joku valmiiksi tehty kilke, mikä lähettää käyttäjän antamaan sähköpostiin varauksen tiedot.
    ...
    /*
    Kun käyttäjä painaa vahvistuslomakkeessa olevaa 'vahvista'-nappia funktio ottaa ylös käyttäjän valitseman päivän, ajan, palvelun tyypin, sähköpostin ja palvelun pituuden, joka tarkistetaan funktiolla checkLength().
    Käyttäjän antama sähköposti validoidaan. Jos sähköposti ei ole oikessa muodossa, siitä ilmoitetaan käyttäjälle alert:n muodossa. Jos käyttäjä on valinnut palvelun tyypin, suoritetaan AJAX:lla POST-pyyntö handler.php:lle. 
